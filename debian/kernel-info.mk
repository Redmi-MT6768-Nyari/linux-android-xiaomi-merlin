...
DEVICE_FULL_NAME = Xiaomi Redmi Note 9
...
# Defconfig to use
KERNEL_DEFCONFIG = merlin_halium_defconfig
...
# If you leave this undefined, an attempt to find it automatically
# will be made.
KERNEL_IMAGE_DTB_OVERLAY = arch/arm64/boot/dts/mediatek/k69v1_64.dtb
...
FLASH_INFO_DEVICE_IDS = merlin merlinnfc
...
DEB_TOOLCHAIN = clang-android-$(CLANG_VERSION), linux-initramfs-halium-generic:arm64, binutils-aarch64-linux-gnu, gcc-4.9-aarch64-linux-android, g++-4.9-aarch64-linux-android, libgcc-4.9-dev-aarch64-linux-android-cross
